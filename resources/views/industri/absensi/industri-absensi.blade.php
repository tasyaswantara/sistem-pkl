...
<x-admin-layout>
    <div class="space-y-6">
        <div class="mb-2">
            ...
            <h1 class="text-gray-900 text-2xl font-semibold mb-2">Absensi Siswa PKL</h1>
        ...
        <form method="GET" action="{{ route('industri.absensi') }}" class="bg-white rounded-lg border border-gray-200 p-6">
