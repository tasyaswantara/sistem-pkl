            ...
            <div class="grid grid-cols-1 gap-4 md:grid-cols-3 xl:grid-cols-6">
                ...
                <div>
                    ...
                    <div class="relative">
                        ...
                        <input type="text" name="q" value="{{ $filters['q'] }}" placeholder="Nama siswa"
                ...
                <table class="w-full min-w-[1200px]">
                    <thead>
                        <tr class="bg-gray-50 border-b border-gray-200">
                            ...
                            <th class="px-6 py-3 text-left text-xs font-semibold text-gray-600 uppercase">Catatan
                                Industri</th>
                            <th class="px-6 py-3 text-left text-xs font-semibold text-gray-600 uppercase">Status
                                Validasi</th>
                            <th class="px-6 py-3 text-left text-xs font-semibold text-gray-600 uppercase">Komentar Guru
                            </th>
                        </tr>
                    </thead>
                                ...
                                <td class="px-6 py-4 text-sm text-gray-700">
                                    <div class="space-y-2 mb-3">
                                        @forelse ($logbook->komentar as $komentar)
                                            <div
                                                class="text-xs text-gray-600 bg-gray-50 border border-gray-200 rounded-lg px-2 py-1">
                                                {{ $komentar->komentar }}
                                            </div>
                                        @empty
                                    ...
                                    <form method="POST" action="{{ route('guru.elogbook.komentar', $logbook->id) }}"
                                        class="flex items-start gap-2">
                                        @csrf
                                        <textarea name="komentar" rows="2"
                                            class="w-full min-w-[190px] px-2.5 py-2 border border-gray-300 rounded-lg text-xs focus:outline-none focus:ring-2 focus:ring-emerald-500/50 focus:border-emerald-500"
