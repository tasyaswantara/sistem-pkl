@section('title', 'Penilaian Bimbingan')
...
<x-admin-layout>
    <div x-data="{ detailOpen: false, detailNama: '', detailIndustri: '', detailList: [], detailTotal: '' }">
        <div class="mb-8">
            ...
            <h1 class="text-gray-900 text-2xl font-semibold mb-2">Penilaian Siswa Bimbingan</h1>
            <p class="text-gray-500 text-sm max-w-2xl">
                Lihat rubrik penilaian dan hasil penilaian dari industri.
            </p>
        </div>
                    ...
                    <tbody class="bg-white divide-y divide-gray-200">
                        ...
                        <tr>
                            <td class="px-6 py-6 text-center text-sm text-gray-500" colspan="5">
                                Belum ada data penilaian siswa bimbingan.
                            </td>
                        </tr>
                        @endforelse
                    </tbody>
