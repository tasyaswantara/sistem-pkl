<header class="flex items-center justify-between px-6 py-4  bg-white/70 backdrop-blur-lg border-b border-gray-200/50 shadow-sm">
    <div class="flex items-center">
        ...
        <div class="relative mx-4 lg:mx-0">
            ...
            <input class="w-32 lg:w-96 pl-10 pr-4 py-2 bg-white/80 border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-emerald-400/50 focus:border-emerald-400 transition-all" type="text" placeholder="Search">
        </div>
    </div>
