...
class AdminPresensiService
{
    ...
    /**
     * @return array{jurusanOptions:Collection<int,Jurusan>,industriOptions:Collection<int,Industri>,tahunAjaranOptions:Collection<int,string>}
     */
    public function getOptions(): array
    {
        return [
            ...
            'tahunAjaranOptions' => Siswa::query()
                ->select('tahun_ajaran')
                ->distinct()
